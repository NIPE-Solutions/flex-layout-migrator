...
export const cliReference = deepFreeze([
  ...
  },
  {
    ...
    evidence: ['src/cli/run-cli.ts', 'src/cli/stylesheet-path.validator.spec.ts'],
  },
  {
    longFlag: '--write',
  ...
  },
  {
    ...
    evidence: ['src/cli/run-cli.ts', 'src/report/json-report.writer.spec.ts'],
  },
  {
    ...
    evidence: ['src/cli/run-cli.ts', 'src/cli/exit-policy.spec.ts'],
  },
  {
    ...
    evidence: ['src/cli/run-cli.ts', 'src/config/breakpoint-migration-config.spec.ts'],
  },
  {
    ...
    evidence: ['src/cli/run-cli.ts', 'src/image/responsive-image.planner.spec.ts'],
  },
  {
