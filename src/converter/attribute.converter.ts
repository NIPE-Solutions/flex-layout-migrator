...
export interface IAttributeConverter<T> {
   ...
   */
  prepare(root: CheerioAPI, element: Cheerio<Element>): T;
   ...
   */
  convert(value: string[], element: Cheerio<Element>, breakPoint?: BreakPoint, context?: AttributeContext<T>): void;
...
export abstract class AttributeConverter<T> implements IAttributeConverter<T> {
  ...
  public prepare(_root: CheerioAPI, _element: cheerio.Cheerio<Element>): T {
    // Override this method to prepare the element
    return {} as T;
  }

  public abstract convert(value: string[], element: Cheerio<Element>, breakPoint?: BreakPoint, context?: T): void;
